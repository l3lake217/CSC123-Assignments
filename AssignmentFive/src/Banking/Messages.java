...
public class Messages {
	...
	public static String MSG_MENU_PROMPT ="\nPlease select an option below\r\n"
										...
										+ "9 – Exit\r\n\n"
										+ "Choice: ";
	public static String MSG_Exit_Bank = "Exiting Banking Application, Thank You.";
	...
	public static String MSG_WITHDRAWL_SUCCESS = "Withdrawl successful, the new balance is: "; 
	public static String MSG_DEPOSIT_SUCCESS = "Deposit successful, the new balance is: "; 
	public static String MSG_THANK_YOU = "Thank you, the account number is "; 
	...
	public static String MSG_WITHDRAWL_FAILED = "Withdrawl failed, the current balance is: "; 
	public static String MSG_DEPOSIT_FAILED = "Deposit failed, the current balance is: "; 
	public static String MSG_ACCOUNT_CLOSED_EXCEPTION = "(AccountClosedException) Account has been closed."; 
	
	public static void accountClosedException() {
		System.out.println(MSG_ACCOUNT_CLOSED_EXCEPTION);
		System.out.println();
	}
	...
	public static void askWithdrawAmount() {
		System.out.println(MSG_ask_AMOUNT_WITHDRAW);
	}
	public static void askDepositAmount() {
		System.out.println(MSG_ask_AMOUNT_DEPOSIT);
	}
	
	public static void askAccountNumber() {
		System.out.println(MSG_ask_ACCOUNT_NUM);
	}
