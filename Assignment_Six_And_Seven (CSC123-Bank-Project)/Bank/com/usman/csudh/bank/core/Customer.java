...
public class Customer implements Serializable{
	...
	public Customer(String fName, String lName, String ssn, String accountCurrency) {
		setFirstName(fName);
		setLastName(lName);
		setSSN(ssn);
	...
	// 5th method added, to store account currency.
	...
	public void setAccountCurrency(String s) {
		accountCurrency=s;
	}
	...
	public String toString() {
		...
		return firstName+" : "+lastName+" : "+ssn;//+accountCurrency.toUpperCase(); 
	}
		...
		return this.firstName.equalsIgnoreCase(other.getFirstName())
				&&this.lastName.equalsIgnoreCase(other.getLastName())
						&&this.ssn.equalsIgnoreCase(other.getSSN())
							&&this.accountCurrency.equalsIgnoreCase(other.getAccountCurrency());
